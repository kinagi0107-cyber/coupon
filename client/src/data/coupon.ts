...
export const coupons: Coupon[] = [
  // ===== 通常配布クーポン =====
  {
    ...
    code: "OBON100OFF",
    description: "お盆の期間、なんと毎日使えちゃいます！/n※利用は一日一回までで、他クーポンとの併用はできません。/n※クーポンを使用する際はお会計の際に従業員に画面をお見せください。会計前に使用済みのボタンを押してしまった場合、使用することが出来ません。/n※金券・金プラには使用できません。",
    expires: "2026-08-16",
  },
  ...
  // ===== コード入力クーポン =====
  {
    ...
    description: "LINEから来てくれたお客様限定！/n/n※利用は一日一回までで、他クーポンとの併用はできません。/n※クーポンを使用する際はお会計の際に従業員に画面をお見せください。会計前に使用済みのボタンを押してしまった場合、使用することが出来ません。/n※金券・金プラには使用できません。",
    expires: "2026-08-16",
    secretCode: "LINEBON",
    maxUses: null,
  },
  {
    ...
    description: "Xから来てくれたお客様限定！/n/n※利用は一日一回までで、他クーポンとの併用はできません。/n※クーポンを使用する際はお会計の際に従業員に画面をお見せください。会計前に使用済みのボタンを押してしまった場合、使用することが出来ません。/n※金券・金プラには使用できません。",
    expires: "2026-08-16",
    secretCode: "XBOON",
    maxUses: null,
  },
